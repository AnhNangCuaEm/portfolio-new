...
const ContactForm: React.FC = () => {
    ...
    return (
        <div className="w-full bg-white/5 backdrop-blur-xl rounded-3xl sm:rounded-4xl p-4 sm:p-8 border border-white/10 shadow-2xl scroll-animate scroll-fade-up scroll-delay-200">
