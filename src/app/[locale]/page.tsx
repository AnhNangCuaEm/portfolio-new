...
export default function HomePage() {
    ...
    return (
        <main role="main" className="flex min-h-screen w-full max-w-6xl mx-auto flex-col items-center justify-center pt-24 pb-4 sm:pt-32 px-4 sm:px-8">
            <div className="w-full backdrop-blur-sm rounded-4xl p-4 sm:p-8 border border-white/20 shadow-2xl">
